...
class SwapQueryServiceTest {
    ...
    void findActiveSwaps_multipleWallets_findsAll() {
        ...
        order1.setCreatorSourceAddress(TestDataBuilder.CREATOR_ADDR);

        Order order2 = TestDataBuilder.matchedOrder(sepolia, polygon, tka, tkb);
        order2.setCreatorSourceAddress("0xother");
        order2.setMatcherSourceAddress(TestDataBuilder.MATCHER_ADDR);
